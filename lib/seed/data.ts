...
export const SECTIONS_DATA = [
  ...
  },
  {
    ...
    order: 4,
    lessons: [
      { title: "Google Sheets Integration", videoUrl: "https://www.youtube.com/watch?v=9L-5o0G-e-I", description: "Connect n8n with Google Sheets for data management.", explanation: "Google Sheets Integration:\n\nAuthentication:\n- OAuth2 or Service Account\n- Create credentials in Google Cloud\n\nOperations:\n- Read: Fetch data from sheets\n- Write: Append or update rows\n- Update: Modify specific cells\n- Create: New spreadsheet\n\nUse Cases:\n- Lead tracking\n- Data collection forms\n- Report generation", resources: [{ name: "Google Sheets API Docs", url: "https://developers.google.com/sheets/api" }], links: [{ name: "n8n Google Sheets Node", url: "https://docs.n8n.io/integrations/builtin/app-nodes/n8n.nodes.google.sheets/" }], duration: "16:00", order: 1 },
      { title: "Slack & Discord Bots", videoUrl: "https://www.youtube.com/watch?v=kY67Z3wD8n0", description: "Build chat bots and notifications with messaging platforms.", explanation: "Messaging Integrations:\n\nSlack:\n- Send messages to channels\n- Interactive buttons\n- Bot commands\n- Workflow notifications\n\nDiscord:\n- Webhook messages\n- Embed formatting\n- Role mentions\n\nSetup:\n- Create Bot in platform\n- Get webhook URL\n- Configure in n8n", resources: [{ name: "Slack API Docs", url: "https://api.slack.com/" }], links: [{ name: "n8n Slack Node", url: "https://docs.n8n.io/integrations/builtin/app-nodes/n8n.nodes.slack/" }], duration: "14:00", order: 2 },
      { title: "Database Connections", videoUrl: "https://www.youtube.com/watch?v=x7A0sJk43C0", description: "Connect to MySQL, PostgreSQL, and MongoDB from n8n.", explanation: "Database Integration:\n\nSupported Databases:\n- MySQL\n- PostgreSQL\n- MongoDB\n- SQLite\n\nOperations:\n- Select (Read)\n- Insert (Create)\n- Update (Modify)\n- Delete (Remove)\n\nBest Practices:\n- Use connection pooling\n- Handle large datasets\n- Secure credentials\n- Query optimization", resources: [{ name: "MongoDB Driver", url: "https://www.mongodb.com/docs/drivers/" }], links: [{ name: "n8n MySQL Node", url: "https://docs.n8n.io/integrations/builtin/app-nodes/n8n.nodes.mysql/" }], duration: "12:45", order: 3 },
      { title: "Email Automation", videoUrl: "https://www.youtube.com/watch?v=KshZ_c2_xO0", description: "Automate email sending and processing.", explanation: "Email Automation:\n\nNodes:\n- Gmail Node\n- SMTP Node\n- SendGrid\n\nFeatures:\n- Send emails\n- Read emails\n- Process attachments\n- Auto-replies\n\nUse Cases:\n- Welcome emails\n- Notifications\n- Report delivery", resources: [{ name: "Gmail API", url: "https://developers.google.com/gmail/api" }], links: [{ name: "n8n Gmail Node", url: "https://docs.n8n.io/integrations/builtin/app-nodes/n8n.nodes.gmail/" }], duration: "11:30", order: 4 },
    ],
  },
  {
    ...
    order: 5,
    lessons: [
      { title: "Webhooks & Triggers", videoUrl: "https://www.youtube.com/watch?v=XWkG85q0H0c", description: "Set up webhooks and event-driven workflows.", explanation: "Triggers:\n\nWebhook Triggers:\n- Receive data from external apps\n- Real-time notifications\n- REST API endpoints\n\nScheduled Triggers:\n- Cron-based execution\n- Interval-based\n- Specific times\n\nOther Triggers:\n- File triggers\n- Email triggers\n- Custom triggers\n\nUse Cases:\n- Form submissions\n- Payment notifications\n- External app sync", resources: [{ name: "Webhook Guide", url: "https://docs.n8n.io/workflows/triggers/" }], links: [{ name: "n8n Webhooks", url: "https://docs.n8n.io/integrations/builtin/trigger-nodes/n8n.nodes.webhook/" }], duration: "15:00", order: 1 },
      { title: "Sub-workflows", videoUrl: "https://www.youtube.com/watch?v=1MwSoB0gnM4", description: "Organize complex automations using sub-workflows.", explanation: "Sub-workflows:\n\nBenefits:\n- Reuse common logic\n- Better organization\n- Easier debugging\n- Modular design\n\nImplementation:\n- Save workflow as template\n- Call via HTTP request\n- Use Execute Workflow node\n\nBest Practices:\n- Clear naming\n- Document inputs/outputs\n- Error handling", resources: [{ name: "Reusable Workflows", url: "https://docs.n8n.io/workflows/#reusing-workflows" }], links: [], duration: "13:20", order: 2 },
      { title: "Scheduling & Cron", videoUrl: "https://www.youtube.com/watch?v=R_Q7P_Dq4yY", description: "Schedule recurring workflows with cron expressions.", explanation: "Scheduling:\n\nCron Basics:\n- minute (0-59)\n- hour (0-23)\n- day of month (1-31)\n- month (1-12)\n- day of week (0-6)\n\nExamples:\n- Every hour: 0 * * * *\n- Daily at midnight: 0 0 * * *\n- Weekly on Monday: 0 0 * * 1\n\nTime Zones:\n- Configure in node settings\n- UTC by default", resources: [{ name: "Cron Parser", url: "https://crontab.guru/" }], links: [{ name: "Schedule Trigger", url: "https://docs.n8n.io/integrations/builtin/trigger-nodes/n8n.nodes.schedule.trigger/" }], duration: "10:00", order: 3 },
    ],
  },
  {
    ...
    order: 6,
    lessons: [
      { title: "Lead Generation Pipeline", videoUrl: "https://www.youtube.com/watch?v=9L-5o0G-e-I", description: "Build a complete lead generation and CRM automation.", explanation: "Lead Generation Pipeline:\n\nFlow:\n1. Form submission (Webflow/Typeform)\n2. Data validation and cleaning\n3. Create CRM contact\n4. Send welcome email\n5. Add to follow-up sequence\n6. Alert sales team\n\nTools:\n- Google Sheets\n- CRM (HubSpot/Salesforce)\n- Email sequences\n- Slack notifications", resources: [{ name: "CRM Integration Guide", url: "https://docs.n8n.io/integrations/builtin/app-nodes/n8n.nodes.hubspot/" }], links: [], duration: "20:00", order: 1 },
      { title: "Social Media Scheduler", videoUrl: "https://www.youtube.com/watch?v=kY67Z3wD8n0", description: "Create an automated social media posting system.", explanation: "Social Media Automation:\n\nComponents:\n- Content calendar in Sheets\n- Image processing\n- Multi-platform posting\n- Engagement tracking\n- Performance reporting\n\nPlatforms:\n- Twitter/X\n- LinkedIn\n- Facebook\n- Instagram\n\nScheduling:\n- Queue system\n- Best time posting\n- Content variety", resources: [{ name: "Social Media APIs", url: "https://developers.facebook.com/" }], links: [], duration: "18:30", order: 2 },
      { title: "Data Pipeline & Reporting", videoUrl: "https://www.youtube.com/watch?v=x7A0sJk43C0", description: "Build an ETL pipeline with automated reporting.", explanation: "Data Pipeline:\n\nETL Process:\n- Extract: Pull from sources\n- Transform: Clean and aggregate\n- Load: Store in destination\n- Report: Generate insights\n\nAutomation:\n- Scheduled runs\n- Error handling\n- Data validation\n- Alert on anomalies\n\nOutput:\n- Dashboard\n- Email reports\n- Slack summaries", resources: [{ name: "ETL Best Practices", url: "https://www.xplenty.com/blog/etl-best-practices/" }], links: [], duration: "22:00", order: 3 },
      { title: "Final Project Walkthrough", videoUrl: "https://www.youtube.com/watch?v=KshZ_c2_xO0", description: "Complete project combining all learned techniques.", explanation: "Complete Project:\n\nCombining Everything:\n- Multiple triggers\n- Complex transformations\n- Database operations\n- External API integrations\n- Error handling\n- Monitoring\n\nProject:\n- Customer onboarding system\n- Form → Validation → CRM → Email → Tasks\n- Complete automation lifecycle\n\nKey Takeaways:\n- Plan first\n- Build incrementally\n- Test thoroughly\n- Monitor production", resources: [{ name: "Complete Guide", url: "https://docs.n8n.io/" }], links: [], duration: "25:00", order: 4 },
    ],
  },
];
