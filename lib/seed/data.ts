...
export const SECTIONS_DATA = [
  {
    ...
    order: 1,
    lessons: [
      { title: "What is n8n?", videoUrl: "https://www.youtube.com/watch?v=4cQWJViybAQ", description: "Introduction to n8n workflow automation platform and its key features.", summary: "n8n (pronounced 'en-eight-en') is a workflow automation tool that connects different applications and services to automate repetitive tasks. It's Node-based, event-driven, source-available, self-hostable, and developer-friendly.", explanation: "## What is n8n?\n\nn8n is a powerful workflow automation tool that allows you to connect apps and services to automate tasks.\n\n### Key Features:\n\n1. **Node-based**: Build automations by connecting nodes on a visual canvas. Each node represents a step (trigger or action).\n\n2. **Event-driven**: Workflows can be triggered by webhooks, schedules, or manually.\n\n3. **Self-hostable**: Run n8n on your own servers for complete data control.\n\n4. **Developer-friendly**: Built on Node.js, with support for custom JavaScript code.\n\n### Comparison with Zapier and Make:\n\n- **Zapier**: Best for non-technical users, simple automations, highest number of integrations\n- **Make**: Middle ground - more visual canvas than Zapier, good for complex logic\n- **n8n**: Best for developers and technical teams - maximum control and flexibility\n\n### Pricing:\n- Zapier/Make: Charge per task/operation\n- n8n Cloud: Charge per workflow execution\n- n8n Self-hosted: Free (fair-code license)\n\n### Key Takeaways:\n- Choose n8n for control, power, and customization\n- Ideal for developers and technical teams\n- Cost-effective for complex, high-volume workflows", images: ["https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800"], resources: [{ name: "WorkOS: n8n Guide", url: "https://workos.com/blog/n8n" }, { name: "Parseur: Zapier vs Make vs n8n", url: "https://parseur.com/blog/zapier-vs-make-vs-n8n" }], links: [{ name: "n8n Official Website", url: "https://n8n.io" }, { name: "n8n Documentation", url: "https://docs.n8n.io" }], duration: "15:00", order: 1 },
