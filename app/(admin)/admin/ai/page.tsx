...
import { MessageSquare, Users, Search, User, Mail, Clock, Send, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="h-[calc(100vh-8rem)]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">AI Questions</h1>
          <p className="text-muted-foreground text-sm">Student questions to AI assistant</p>
        </div>
                ...
                {filteredThreads.map((thread) => (
                  ...
                  >
                    ...
                    <p className="text-xs truncate mt-1 opacity-80">
                      {thread.questions[0]?.question || "No questions"}
                    </p>
                    <p className="text-xs opacity-60 mt-1">
                      {thread.questions.length} question{thread.questions.length !== 1 ? "s" : ""}
                    </p>
                  </button>
                ))}
              </div>
