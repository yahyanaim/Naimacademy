          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Name and email address (for account creation, comments, and voting)</li>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>Allow you to participate in article discussions through comments</li>
                <li>Enable article voting (upvotes and downvotes) to help identify quality content</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">3. Comments and Voting System</h2>
              <p>Our article pages include interactive features:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>Comments:</strong> You can leave comments on articles by providing your name and email. Comments are associated with your email address.</li>
                <li><strong>Voting:</strong> You can upvote or downvote articles. Your vote is associated with your email address.</li>
                <li><strong>Identity Sharing:</strong> If you are logged in or have previously commented, your identity is remembered for voting (and vice versa) without requiring re-entry.</li>
                <li><strong>Guest Participation:</strong> You can comment and vote without creating an account by simply providing your name and email.</li>
                <li><strong>Data Retention:</strong> Comments and votes are stored with your provided name and email. You can request deletion of your comments by contacting us.</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">4. Email Communication</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">5. Profile Photos</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">6. Transparency</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">7. Bank Transfer Details</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">9. Account Deletion</h2>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>Your comments and votes on articles</li>
              </ul>
