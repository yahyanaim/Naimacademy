      ...
      <main className="pt-28 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mt-8">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener" className="p-2.5 rounded-full bg-black hover:bg-black transition-all" aria-label="Twitter">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener" className="p-2.5 rounded-full bg-black hover:bg-gradient-to-r hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] transition-all" aria-label="Instagram">
            ...
            <a href="mailto:hello@naimacademy.com" className="p-2.5 rounded-full bg-black hover:bg-red-500 transition-all" aria-label="Email">
