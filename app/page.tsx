    ...
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: "#fefdfb" }}>
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-20 pb-8 lg:px-8 max-w-5xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-3 mt-8">
          ...
          <a href={shareLinks.facebook} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-black hover:bg-[#1877F2] text-white hover:text-white transition-colors">
          ...
          <a href={shareLinks.twitter} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-black hover:bg-black text-white hover:text-white transition-colors">
          ...
          <a href={shareLinks.linkedin} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-black hover:bg-[#0A66C2] text-white hover:text-white transition-colors">
          ...
          <a href={shareLinks.email} className="p-2 rounded-full bg-black hover:bg-red-600 text-white hover:text-white transition-colors">
