...
import { CheckCircle, ChevronRight, Menu, BookOpen } from "lucide-react";
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="sticky top-0 z-50 flex items-center gap-3 px-4 py-3 bg-background border-b border-border lg:hidden">
          <Sheet>
            <SheetTrigger render={<Button variant="ghost" size="icon" className="size-9 -ml-2" />}>
            ...
            >
              <div className="px-5 py-4 border-b border-border flex items-center gap-2">
                ...
                <SheetTitle className="text-sm font-medium">{course?.title ?? "Course Contents"}</SheetTitle>
              </div>
