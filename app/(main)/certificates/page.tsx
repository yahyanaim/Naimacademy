  ...
  return (
    <div className="flex items-center gap-2 mt-2">
      ...
      <a
        ...
        title="Share on X"
      >
        <svg className="size-4 text-white hover:text-[#1D9BF0]" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 rounded-full bg-black hover:bg-[#1877F2] transition-colors"
        title="Share on Facebook"
      >
        <svg className="size-4 text-white hover:text-[#1877F2]" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 rounded-full bg-black hover:bg-[#0A66C2] transition-colors"
        title="Share on LinkedIn"
      >
        <svg className="size-4 text-white hover:text-[#0A66C2]" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 rounded-full bg-black hover:bg-[#25D366] transition-colors"
        title="Share on WhatsApp"
      >
        <svg className="size-4 text-white hover:text-[#25D366]" viewBox="0 0 24 24" fill="currentColor">
      ...
      <button
        onClick={copyLink}
        className="p-2 rounded-full bg-black hover:bg-muted transition-colors"
        title="Copy link"
      >
