...
function ShareButtons({ cert }: { cert: Certification }) {
  ...
  return (
    <div className="flex items-center gap-2 mt-2">
      ...
      >
        <svg className="size-4 text-white" viewBox="0 0 24 24" fill="#1877F2">
      ...
      >
        <svg className="size-4 text-white" viewBox="0 0 24 24" fill="#0A66C2">
      ...
      >
        <svg className="size-4 text-white" viewBox="0 0 24 24" fill="#25D366">
