        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-muted-foreground mt-1 max-w-sm">
              Be the first to say hello! Chat with other students in the community.
            </p>
          </div>
        ) : (
          <>
                  ...
                  {dateMessages.map((message) => {
                    ...
                    return (
                      ...
                      >
                        {/* Avatar */}
                        {!isOwn && (
                          <div className="size-10 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center flex-shrink-0 overflow-hidden shadow-sm">
                            {message.authorAvatar ? (
                              <Image src={message.authorAvatar} alt="" width={40} height={40} className="object-cover" />
                            ) : (
                        ...
                        <div className={`max-w-[70%] ${isOwn ? "items-end" : ""}`}>
                          ...
                          {!isOwn && (
                            <div className="flex items-center gap-2 mb-1.5 ml-1">
                              <span className="text-sm font-semibold">{escapeHtml(message.authorName)}</span>
        ...
        <div className="flex gap-3 items-end max-w-3xl mx-auto">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 border rounded-full bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 text-base"
            />
          </div>
          <Button
            size="icon"
