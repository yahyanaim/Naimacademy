...
export default function CommunityLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] bg-muted/30">
      ...
      {/* Main Content */}
      <main className={cn(
        "flex-1 min-h-full transition-all duration-300 ml-0 md:ml-64 pr-0 md:pr-96"
      )}>
        {children}
      </main>
      ...
      {chatOpen && (
        <div
          className={cn(
            "fixed right-4 bottom-20 w-80 bg-white dark:bg-[#15202b] border border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 z-40 rounded-2xl shadow-2xl",
